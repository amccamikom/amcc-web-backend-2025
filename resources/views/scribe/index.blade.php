    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="notes">
                    <a href="#notes">Notes</a>
                                ...
                                <a href="#notes-GETapi-notes">Daftar semua notes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="notes-GETapi-notes--note_id-">
                                <a href="#notes-GETapi-notes--note_id-">Tampilkan note tertentu</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="notes-POSTapi-notes">
                                <a href="#notes-POSTapi-notes">Membuat note baru</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="notes-PUTapi-notes--note_id-">
                                <a href="#notes-PUTapi-notes--note_id-">Update note</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="notes-DELETEapi-notes--note_id-">
                                <a href="#notes-DELETEapi-notes--note_id-">Hapus note</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="users">
                    <a href="#users">Users</a>
                                ...
                                <a href="#users-POSTapi-users">Membuat user baru</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-GETapi-users">
                                <a href="#users-GETapi-users">Daftar semua users</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-GETapi-users--user_id-">
                                <a href="#users-GETapi-users--user_id-">Tampilkan user tertentu</a>
                            </li>
                                ...
                                <a href="#users-DELETEapi-users--user_id-">Hapus user</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>APIs untuk autentikasi user</p>
...
<p>Melakukan autentikasi user dan mengembalikan token akses.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs untuk mengelola notes</p>

                                <h2 id="notes-GETapi-notes">Daftar semua notes</h2>

<p>
</p>

<p>Mengembalikan daftar semua notes yang ada di database.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="notes-GETapi-notes--note_id-">Tampilkan note tertentu</h2>

<p>
</p>

<p>Menampilkan detail note berdasarkan ID.</p>

<span id="example-requests-GETapi-notes--note_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/notes/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-notes--note_id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-notes--note_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-notes--note_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-notes--note_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-notes--note_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-notes--note_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-notes--note_id-" data-method="GET"
      data-path="api/notes/{note_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-notes--note_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-notes--note_id-"
                    onclick="tryItOut('GETapi-notes--note_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-notes--note_id-"
                    onclick="cancelTryOut('GETapi-notes--note_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-notes--note_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/notes/{note_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="note_id"                data-endpoint="GETapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="note"                data-endpoint="GETapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
<p>ID dari note. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="notes-POSTapi-notes">Membuat note baru</h2>

<p>
</p>

<p>Membuat note baru dengan data yang diberikan.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value=""Judul Note Pertama""
               data-component="body">
    <br>
<p>Judul note. Example: <code>"Judul Note Pertama"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value=""Ini adalah content note pertama""
               data-component="body">
    <br>
<p>Isi content. Example: <code>"Ini adalah content note pertama"</code></p>
        </div>
        </form>

                    <h2 id="notes-PUTapi-notes--note_id-">Update note</h2>

<p>
</p>

<p>Mengupdate data note yang sudah ada.</p>

<span id="example-requests-PUTapi-notes--note_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-notes--note_id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-notes--note_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-notes--note_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-notes--note_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-notes--note_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-notes--note_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-notes--note_id-" data-method="PUT"
      data-path="api/notes/{note_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-notes--note_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-notes--note_id-"
                    onclick="tryItOut('PUTapi-notes--note_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-notes--note_id-"
                    onclick="cancelTryOut('PUTapi-notes--note_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-notes--note_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="note_id"                data-endpoint="PUTapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the note. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="note"                data-endpoint="PUTapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
<p>ID dari note. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-notes--note_id-"
               value=""Judul Note Update""
               data-component="body">
    <br>
<p>Judul note. Example: <code>"Judul Note Update"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>content</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="PUTapi-notes--note_id-"
               value=""Ini adalah content note yang sudah diupdate""
               data-component="body">
    <br>
<p>Isi content. Example: <code>"Ini adalah content note yang sudah diupdate"</code></p>
        </div>
        </form>

                    <h2 id="notes-DELETEapi-notes--note_id-">Hapus note</h2>

<p>
</p>

<p>Menghapus note dari database.</p>

<span id="example-requests-DELETEapi-notes--note_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-notes--note_id-">
            <blockquote>
...
<span id="execution-results-DELETEapi-notes--note_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-notes--note_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-notes--note_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-notes--note_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-notes--note_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-notes--note_id-" data-method="DELETE"
      data-path="api/notes/{note_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-notes--note_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-notes--note_id-"
                    onclick="tryItOut('DELETEapi-notes--note_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-notes--note_id-"
                    onclick="cancelTryOut('DELETEapi-notes--note_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-notes--note_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-notes--note_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="note_id"                data-endpoint="DELETEapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the note. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="note"                data-endpoint="DELETEapi-notes--note_id-"
               value="1"
               data-component="url">
    <br>
<p>ID dari note. Example: <code>1</code></p>
    ...
    <p>APIs untuk mengelola users</p>

                                <h2 id="users-POSTapi-users">Membuat user baru</h2>

<p>
</p>

<p>Membuat user baru dengan data yang diberikan.</p>
...
<p>Password user. Example: <code>"password"</code></p>
                    ...
                    <h2 id="users-GETapi-users">Daftar semua users</h2>

<p>
</p>

<p>Mengembalikan daftar semua users yang ada di database.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="users-GETapi-users--user_id-">Tampilkan user tertentu</h2>

<p>
</p>

<p>Menampilkan detail user berdasarkan ID.</p>
...
<p>Mengupdate data user yang sudah ada.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nama user. Example: <code>"Jane Doe"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email user. Example: <code>"jane@example.com"</code></p>
        </div>
        </form>

                    <h2 id="users-DELETEapi-users--user_id-">Hapus user</h2>
